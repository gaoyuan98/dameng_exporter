...
const (
	...
	dmdbms_redo_switch_last_time_seconds string = "dmdbms_redo_switch_last_time_seconds"
	dmdbms_redo_switch_interval_seconds  string = "dmdbms_redo_switch_interval_seconds"
